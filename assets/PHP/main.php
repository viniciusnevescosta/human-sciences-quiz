...
<body>
    <div class="container">
        ...
        <section class="hero">
            ...
            <div class="img1">
                <img src="../IMGS/img1.svg" alt="Earth care" draggable="false">
            </div>
        </section>
        ...
        <main class="main">
            <section class="about" id="about">
                <article class="desc">
                    ...
                    <br>
                    <p>
                        A área das Ciências Humanas é o conjunto de ciências que tem como objeto de estudo o ser humano. Entre as ciências da área de humanas, estão a Filosofia, Sociologia ou Ciências Sociais, História, Geografia, Letras, Teologia, Antropologia, Comunicação Social, Psicologia, Linguística, Artes, entre outras.
                    </p>
                </article>
            </section>
            ...
            <section class="singup">
                <div id="cadastro">
                    ...
                    <form method="POST" action="main.php">
                        ...
                        <nav class="abrir">
                            <ul>
                                <li><a class="abrir">Já tem uma conta?</a></li>
                            </ul>
                            <input type="submit" value="Concluir" class="abrir">
                        </nav>
                    </form>
                </div>
            </section>
            ...
            <div class="modal">
                ...
                <div class="login">
                    ...
                    <form method="POST" action="login.php">
                        ...
                        <nav>
                            <ul>
                                <li><a href="#cadastro" class="abrir">Criar uma conta?</a></li>
                            </ul>
                            <input class="abrir" type="submit" value="Entrar">
                        </nav>
                    </form>
                </div>
            </div>
